...
$ecms_config['db']['dbserver']='m9g0lzx9.2419lan.dnstoo.com';	//数据库登录地址
$ecms_config['db']['dbport']='3306';	//端口，不填为按默认
$ecms_config['db']['dbusername']='prh1rh_f';	//数据库用户名
$ecms_config['db']['dbpassword']='xgp4dx6b';	//数据库密码
$ecms_config['db']['dbname']='prh1rh';	//数据库名
$ecms_config['db']['setchar']='utf8';	//设置默认编码
$ecms_config['db']['dbchar']='utf8';	//数据库默认编码
$ecms_config['db']['dbtbpre']='yc_';	//数据表前缀
...
//后台安全设置
$ecms_config['esafe']['loginauth']='147258';	//登录认证码,如果设置登录需要输入此认证码才能通过
$ecms_config['esafe']['enloginauth']=0;	//登录认证码加密验证串有效时间,单位:秒(0为不启用加密)
$ecms_config['esafe']['ecookiernd']='wbRz5F42jLPhx7ihzac7OzZgKXd3GtUiaD5x';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='jigox';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='afqxy';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='QJdfnztrQWgO4s3vJFyAuCVI6Tf8IOTCLZn';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='SCFt2vgQDhUMGVmaMob4BAQHGUUsBQ9CYw';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='3tkORrm20mZIAbtuESFhAk7RjIRAMi0iD';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='aNrAx1TkSMZ8FYZzOj7JVg0VCC7mt2SP';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='9TXnGBVRGoyrxvgQNJUuLZUFgf4h4Wy';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'源楚（成都）化工科技有限公司',
'newsurl'=>'/',
...
'keytog'=>2,
'keytime'=>900,
'keyrnd'=>'dPkTTsJE8lk4mlQ6eAVzy9Xw71rHM7qu',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/gywm/\">关于我们</a>&nbsp;|&nbsp;<a href=\"/gcal/\">工程案例</a>&nbsp;|&nbsp;<a href=\"/jjfa/\">解决方案</a>&nbsp;|&nbsp;<a href=\"/scjgjd/\">生产加工基地</a>&nbsp;|&nbsp;<a href=\"/xwdt/\">新闻动态</a>&nbsp;|&nbsp;<a href=\"/lxwm/\">联系我们</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'d9kKKXA6RNH0k39JXGH75Y9he6jmW0LvzzNX',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'BJQJB3jYcRJMER1So3YCkAh7jNxQPGqXdLjSMuSy1e',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>0,
...
'definfovoteid'=>0,
'orderf'=>'',
'sonclass'=>'|3|4|5|6|7|9|10|11|12|13|14|17|18|20|21|',
'maddfun'=>'',
'meditfun'=>'',
'qmaddfun'=>'',
'qmeditfun'=>'',
