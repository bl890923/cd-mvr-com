...
E_D("DROP TABLE IF EXISTS `yc_enewsmoreport`;");
E_C("CREATE TABLE `yc_enewsmoreport` (
...
E_D("replace into `yc_enewsmoreport` values('1',0xe4b8bbe8aebfe997aee7abaf,'','','','','0','0','0','0','','0','0');");
