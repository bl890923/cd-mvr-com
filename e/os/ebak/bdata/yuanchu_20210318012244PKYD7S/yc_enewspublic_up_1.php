...
E_D("DROP TABLE IF EXISTS `yc_enewspublic_up`;");
E_C("CREATE TABLE `yc_enewspublic_up` (
...
E_D("replace into `yc_enewspublic_up` values('1','1355124469','1355124476','36','0',0x7c312c33367c,'','1615949910','1615949910','36','0','0','0');");
