...
E_D("DROP TABLE IF EXISTS `yc_enewsclass_stats_set`;");
E_C("CREATE TABLE `yc_enewsclass_stats_set` (
...
E_D("replace into `yc_enewsclass_stats_set` values('0','3600','0','20170227');");
